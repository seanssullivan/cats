...
describe('#breedDetails', () => {
  ...
  it('returns undefined when details for the breed are unavailable', () => {
    const expected = undefined;
    const aegean = breedDetails('Aegean');
    assert.equal(expected, aegean);
  });

  it('returns undefined when no breed is provided', () => {
    const expected = undefined;
